...
export default function AccountBalance() {
  ...
  console.log(statusBalance,"balance");
  return (
    <div tw="max-w-screen-lg mx-auto">
          ...
          <div tw="flex items-center">
            <span tw="capitalize text-4xl font-bold text-black">Balance Sheet</span>
          </div>
             ...
             <table>
               ...
               <tbody>
                 ...
                 <tr tw="text-left text-sm border-b   border-gray-200">
                   ...
                   <td tw="text-right py-2"> {dataBalance?.cash_and_bank?.petty_cash !== null && numberWithDot(dataBalance?.cash_and_bank?.petty_cash)} </td>
                 </tr>
                 <tr tw="text-left text-sm border-b   border-gray-200">
                   ...
                   <td tw="text-right grid">
                     {" "}
                     <span tw="font-bold">{dataBalance?.cash_and_bank?.total !== null && numberWithDot(dataBalance?.cash_and_bank?.total)}</span>
                 ...
                 <tr tw="text-left text-sm border-b   border-gray-200">
                   ...
                   <td tw="text-right py-2"> {dataBalance?.current_asset?.accounts_receivable !== null && numberWithDot(dataBalance?.current_asset?.accounts_receivable)} </td>
                 </tr>
                 <tr tw="text-left text-sm border-b   border-gray-200">
                   ...
                   <td tw="text-right grid">
                     {" "}
                     <span tw="font-bold">{dataBalance?.current_asset?.total !== null && numberWithDot(dataBalance?.current_asset?.total)}</span>
                     <span tw="font-light text-xs">IDR</span>
                   </td>
                 </tr>
               </tbody>
               <tfoot>
                 <tr className="double">
                   ...
                   <td tw="text-right grid pt-3">
                     {" "}
                     <span tw="font-bold">{dataBalance?.total_assets !== null && numberWithDot(dataBalance?.total_assets)}</span>
                     <span tw="font-light text-xs">IDR</span>
                   </td>
                 </tr>
               </tfoot>
             ...
             <table>
               ...
               <tbody>
                 ...
                 <tr tw="text-left text-sm border-b   border-gray-200">
                   ...
                   <td tw="text-right py-2"> {dataBalance?.income?.net_income !== null && numberWithDot(dataBalance?.income?.net_income)} </td>
                 </tr>
                 <tr tw="text-left text-sm border-b   border-gray-200">
                   ...
                   <td tw="text-right grid">
                     {" "}
                     <span tw="font-bold">{dataBalance?.income?.total_equity !== null && numberWithDot(dataBalance?.income?.total_equity)}</span>
                     <span tw="font-light text-xs">IDR</span>
                   </td>
                 </tr>
               </tbody>
               <tfoot>
                 <tr className="double">
                   ...
                   <td tw="text-right grid pt-3">
                     {" "}
                     <span tw="font-bold">{dataBalance?.income?.total_equity}</span>
                     <span tw="font-light text-xs">IDR</span>
                   </td>
                 </tr>
               </tfoot>
