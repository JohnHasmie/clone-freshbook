...
export default function AccountBalancePrint() {
...
// }, []);
  ...
  return (
    <div tw="max-w-screen-lg mx-auto my-10" >
   ...
   <CardReporting ref={myRef} tw="md:col-span-9 mb-10  mt-10 md:mt-2">
