import { Avatar, Checkbox, Menu, Modal, Popover, Table } from "antd";
      ...
      <div tw="w-full md:w-[98%] md:mb-5">
        ...
        >
          <div tw="flex items-center">
            <span tw="text-xl font-bold text-black">Items</span>
            {checked.length > 0 && (
              <>
        ...
        <div tw="flex justify-between mt-5">
          ...
          <div tw="flex flex-col items-center">
            <button onClick={()=>history.push('items/archived')} tw="cursor-pointer border border-gray-200 px-3 py-1 text-sm rounded bg-transparent hover:bg-gray-200 ">
