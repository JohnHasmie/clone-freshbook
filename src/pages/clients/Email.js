...
export default function Email() {
  ...
  const mutation = useMutation(
    async (data) => {
      return axios.delete(`mail-log/${data}`).then((res) => res.data);
    },
    {
      onSuccess: () => {
      ...
      <div className="layout-content">
        <div tw="max-w-screen-lg mb-20">
          ...
          <div tw="mt-20">
            ...
            >
              <span tw="text-lg">
                {`Are you sure you want to ${isType} this email log?`}
              </span>
            </ModalConfirm>
            <Modal
            ...
            <div tw="flex justify-between mt-5">
              ...
              <div tw="flex flex-col items-center">
                <button
                  onClick={() => history.push("/clients/sent-email/deleted")}
