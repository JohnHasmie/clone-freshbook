...
import { AppstoreAddOutlined, DollarCircleOutlined, FieldTimeOutlined, FileDoneOutlined, PieChartOutlined, PlusOutlined, SnippetsOutlined, SyncOutlined } from "@ant-design/icons";
  ...
  const data = [
    {
      ...
      desc:<span>A breakdown of Company Name's activity over a period of time</span>

    },
    {
        icon:   <FileDoneOutlined />,
        title: <h1>Invoice Details</h1>,
        desc:<span>A summary of the invoices you've sent over a period of time</span>
  
      },
      {
        icon: <AppstoreAddOutlined />,
        title: <h1>Revenue by Client</h1>,
        desc:<span>A breakdown of how much revenue Company Name is bringing in</span>
