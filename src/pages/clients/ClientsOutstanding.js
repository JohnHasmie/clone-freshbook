...
console.log("data",dataOutstanding?.outstanding_invoices?.invoices);
  ...
  // dataOutstanding?.outstanding_invoices?.invoices?.map((item) => ({
  //   key: item?.id,
...

    {
      ...
      render: (text, record) => (
        <div tw="z-50">
          ...
          <span>{`${filterOutstanding.currency === "USD"
                                  ? "$"
              ...
              <div tw="flex items-center">
                {hasSelected ? (
                  <>
                    ...
                    <span tw="text-xl font-bold text-black ml-2"> Clients with Outstanding Invoices</span>
                  ...
                  <>
                  <span   onClick={() => history.push('/clients')} tw="text-xl font-bold text-primary">All Clients</span>
                  <RightOutlined tw=" ml-2" />
